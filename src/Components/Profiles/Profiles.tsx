    ...
    return (
        <div className="tab-pane fade" id="v-pills-profiles" role="tabpanel" aria-labelledby="v-pills-profiles-tab">
            <div className="container"> 
                <h4 className="mb-3 text-light">Сохраненные профили</h4>          
                ...
                <tbody id="profilesTable">
                    {
                        Object.keys(profiles).map((key,index)=>{
                            ...
                            <td>
                                ...
                                <button className="btn btn-outline-secondary btn-sm text-light" id="DeleteProfile" onClick={()=>Delete(profiles[key]?.profileName)}>
                                    <svg xmlns="http://www.w3.org/2000/svg" width={16} height={16} fill="currentColor" className="bi bi-trash" viewBox="0 0 16 16">
                                    <path d="M5.5 5.5A.5.5 0 0 1 6 6v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm2.5 0a.5.5 0 0 1 .5.5v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm3 .5a.5.5 0 0 0-1 0v6a.5.5 0 0 0 1 0V6z" />
                                    <path fillRule="evenodd" d="M14.5 3a1 1 0 0 1-1 1H13v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V4h-.5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1H6a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1h3.5a1 1 0 0 1 1 1v1zM4.118 4L4 4.059V13a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4.059L11.882 4H4.118zM2.5 3V2h11v1h-11z" />
                                    </svg>
                                </button>
                                <button className="btn btn-outline-secondary btn-sm text-light" data-bs-toggle="modal" data-bs-target="#editProfile" onClick={()=>editProfile(profiles[key]?.profileName)}>
                ...
                <div className="modal-content">
                    ...
                    <form onSubmit={saveEdited} className="needs-validation">
                        ...
                        <div className="container row g-6" id="profileName">
                            ...
                            <input onChange={handleChange} type="profileName" className="form-control" id="profileName" value={edit?.profileName} required />
                            </div>
                        </div>    
                        </div>
                        <br />
                        ...
                        <div className="container row g-6" id="Address">
                            ...
                            <input onChange={handleChange} value={edit?.firstName} type="text" className="form-control" id="firstName" required />
                            </div>
                            <div className="col-6">
                            <label htmlFor="lastName" className="form-label">Фамилия</label>
                            <input onChange={handleChange} value={edit?.lastName} type="text" className="form-control" id="lastName" required />
                            ...
                            <input onChange={handleChange} value={edit?.email} type="email" className="form-control" id="email" required />
                            {/* <div class="invalid-feedback">
                            ...
                            <input onChange={handleChange} value={edit?.address1} type="text" className="form-control" id="address1" required />
                            {/* <div class="invalid-feedback">
                            ...
                            <input onChange={handleChange} value={edit?.address2} type="text" className="form-control" id="address2" required />
                            </div>
                            <div className="col-3">
                            ...
                            <input onChange={handleChange} value={edit?.country} type="text" className="form-control" id="country" required />
                            </div>
                            <div className="col-3">
                            <label htmlFor="province" className="form-label"> Область / Штат <span className="text-muted" /></label>
                            <input onChange={handleChange} value={edit?.province} type="text" className="form-control" id="province" required />
                            </div>
                            <div className="col-3">
                            <label htmlFor="postCode" className="form-label">Zip</label>
                            <input onChange={handleChange} value={edit?.postCode} type="text" className="form-control" id="postCode" required />
                            {/* <div class="invalid-feedback">
                                        Zip code required.
                                    </div> */}
                            </div>
                        ...
                        <div className="container row g-6" id="Cart">
                            ...
                            <input onChange={handleChange} value={edit?.cardNumber} type="text" className="form-control" id="cardNumber" required />
                            </div>
                            <div className="col-6">
                            <label htmlFor="cardHolderName" className="form-label">Имя на карте</label>
                            <input onChange={handleChange} value={edit?.cardHolderName} type="text" className="form-control" id="cardHolderName" required />
                            </div>
                            <div className="col-2">
                            <label htmlFor="month" className="form-label">mnth</label>
                            <input onChange={handleChange} value={edit?.month} type="text" className="form-control" id="month" required />
                            </div>
                            <div className="col-2">
                            <label htmlFor="year" className="form-label">card yr</label>
                            <input onChange={handleChange} value={edit?.year} type="text" className="form-control" id="year" required />
                            </div>
                            <div className="col-2">
                            <label htmlFor="cvv" className="form-label">CVV</label>
                            <input onChange={handleChange} value={edit?.cvv} type="text" className="form-control" id="cvv" required />
                            </div>
                        </div>
                        </div>
                        <br />
                        <button className="btn btn-primary" id="editProfileButton">Сохранить</button>
                        <br />  
                    </form>
                    </div>
                </div>
