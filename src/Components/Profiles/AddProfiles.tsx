...
import { ADD_PROFILE, ProfileDisparcher } from '../../store/profilesReducer';
        ...
        <div className="col-12">
          <p>
            <button
              ...
              data-target="#EpicCollapse"
              aria-expanded="false"
              aria-controls="EpicCollapse"
              id="AddProfile"
            >
              Add new profile
            </button>
            ...
            >
              <div className="card card-body">
                <div className="container row g-6" id="NewAddress">
                  <div className="col">
                    <h4 /*htmlFor="profileName"*/ className="form-label">
                      Название профиля
                    </h4>
                    <input
